...
for(age in ages)
{
  ...
  caption_text <- paste0("Simulation results for age ", age, " data generated with ", corstr_pres, " and ", 
                         corstr_sev, " correlation structures for presence and severity respectively - properties of direct estimates.")
  ...
  print(xtable(table[[age_ind]], 
               align = c("l", rep("c", 13)),
               digits = c(0, 0, rep(3, 12))),  # 0 for column 1 (text), 3 for rest
