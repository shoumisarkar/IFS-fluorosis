...
if(length(unique(temp$FRI_Score))!=4)
{
  ...
  path_pres_JK = paste0("/blue/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N", N, "/", mode, "/",
  ...
  path_sev_JK = paste0("/blue/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N", N, "/", mode, "/",
