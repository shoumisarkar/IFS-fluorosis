...
N = 10000
mc_seed = 2 #change this as needed
age = 13 #change this as needed
...
dir.create(paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N", N))

dir.create(paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N", N, "/", mode))
...
obj = load(paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05a_combined_presence_modelling/exchangeable,exchangeable/whole_data_based/coefs_pres_age9.RData"))
...
if(all(c(1,2) %in% unique(temp$FRI_Score)))
{
  ...
  path_pres = paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N",
  ...
  path_sev = paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N",
  ...
  setwd(paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/06_simulation/N", N, "/", mode, "/",
               corstr_pres, ",", corstr_sev, "/age", age))
