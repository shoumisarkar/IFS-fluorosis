...
corstr_pres = "jackknifed" #"independence"
corstr_sev =  "jackknifed" # "exchangeable"  #"independence" #"exchangeable"
...
if(all(c(1,2) %in% unique(temp$FRI_Score)))
{
  ...
  {
    JK_corr_mat_pres = MC_output$JK_corrmat_pres
  }
  ...
  {
    JK_corr_mat_sev = MC_output$JK_corrmat_sev
  }
