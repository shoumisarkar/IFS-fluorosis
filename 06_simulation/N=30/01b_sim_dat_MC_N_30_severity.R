...
if(length(unique(temp$FRI_Score))!=4)
{
  ...
  MC_output = fit_GEE_severity(dat=MC_dataset, corstr_sev = corstr_sev, kappa=0.25, maxIter = 100)
  ...
  for(ID in unique(MC_dataset$SUBJECT_ID))
  {
    ...
    {
      MC_output_JK = 
        fit_GEE_severity(dat=MC_dataset_JK, corstr_sev = corstr_sev, kappa=0.25, maxIter = 100)
