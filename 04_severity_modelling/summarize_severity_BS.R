...
write_CI_to_excel_preJS <- function(CI_list, filename, corstr_sev, conf_level) {
  wb <- createWorkbook()
  ...
  saveWorkbook(wb, paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/04_severity_modelling/preJS_",
                          conf_level, "_CI_", corstr_sev, ".xlsx"), overwrite = TRUE)
}

# Helper function to write CI results to Excel
write_CI_to_excel_postJS <- function(CI_list, filename, corstr_sev, conf_level) {
  wb <- createWorkbook()
  ...
  saveWorkbook(wb, paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/04_severity_modelling/postJS_",
                          conf_level, "_CI_", corstr_sev, ".xlsx"), overwrite = TRUE)
}
...
save(stdcoefs_BS_list, file = paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/04_severity_modelling/preJS_stdcoefBS_",
                                     corstr_sev, ".RData"))
...
write_CI_to_excel_preJS(preJS_CI_95, "preJS_stdcoefBS", corstr_sev, 95)
write_CI_to_excel_preJS(preJS_CI_90, "preJS_stdcoefBS", corstr_sev, 90)
...
write_CI_to_excel_postJS(postJS_CI_95, "postJS_stdcoefBS", corstr_sev, 95)
write_CI_to_excel_postJS(postJS_CI_90, "postJS_stdcoefBS", corstr_sev, 90)
