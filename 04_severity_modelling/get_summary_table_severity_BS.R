...
write_CI_to_excel <- function(CI_list, corstr_sev, conf_level) {
  wb <- createWorkbook()
...
write_CI_to_excel(create_summary_table(95), corstr_sev, 95)
write_CI_to_excel(create_summary_table(90), corstr_sev, 90)