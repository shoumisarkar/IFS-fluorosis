...
for(age in ages)
{
    ...
    
  {
    ...
    stdcoefs_BS_mat[,b] = std_coef_sev$`Standardized Estimate`[-c(1:4)]
  }
...
filename_stdcoefs_BS_list = paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05b_combined_severity_modelling/preJS_sev_stdcoefBS_",
...
get_CI = function(confidence_level=0.95, BS_dat)
{
  ...
  d = data.frame(Variable=rownames(std_coef_sev)[-c(1:4)], 
...
saveWorkbook(wb_95, paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05b_combined_severity_modelling/sev_95_CI_",
                            corstr_pres, ",", corstr_sev, ".xlsx"), overwrite = TRUE)
...
saveWorkbook(wb_90, paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05b_combined_severity_modelling/sev_90_CI_",
                            corstr_pres, ",", corstr_sev, ".xlsx"), overwrite = TRUE)
