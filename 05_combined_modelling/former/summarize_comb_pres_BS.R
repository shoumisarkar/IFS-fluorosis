...
write_CI_to_excel_preJS <- function(CI_list, filename, corstr_pres, corstr_sev, conf_level) {
  ...
  saveWorkbook(wb, paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05a_combined_presence_modelling/preJS_",
...
write_CI_to_excel_postJS <- function(CI_list, filename, corstr_pres, corstr_sev, conf_level) {
  ...
  saveWorkbook(wb, paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05a_combined_presence_modelling/postJS_",
                          conf_level, "_CI_", corstr_pres, ",", corstr_sev, ".xlsx"), overwrite = TRUE)
}
...
# Main logic
corstr_pres <- "ar1" #"independence"
corstr_sev = "ar1" #"independence" 
ages <- c(9, 13, 17, 23)
B <- 120
...
save(stdcoefs_BS_list, file = paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05a_combined_presence_modelling/preJS_stdcoefBS_",
...
save(stdcoefsJS_BS_list, file = paste0("W:/somnath.datta/shoumisarkar/Fluorosis/Results/05a_combined_presence_modelling/postJS_stdcoefBS_",
                                       corstr_pres, ",", corstr_sev, ".RData"))
...
write_CI_to_excel_postJS(postJS_CI_95, "postJS_stdcoefBS", corstr_pres, corstr_sev, 95)
write_CI_to_excel_postJS(postJS_CI_90, "postJS_stdcoefBS", corstr_pres, corstr_sev, 90)
