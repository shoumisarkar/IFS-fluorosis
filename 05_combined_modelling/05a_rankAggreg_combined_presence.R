...
#Get variable names
temp = read_xlsx(paste0("path/to/Fluorosis/Results/05a_combined_presence_modelling/95_table_",
...
write_table_to_latex <- function(all_outputs) {
  ...
  tex_file <- paste0("path/to/Fluorosis/Results/05a_combined_presence_modelling/RankAggreg_combined_pres.tex")
  sink(tex_file)
